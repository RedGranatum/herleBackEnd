...
class CompraDetalle(models.Model):
	...
	calibre        = models.DecimalField(max_digits=7, decimal_places=4,default=0.00)
	ancho          = models.DecimalField(max_digits=7, decimal_places=4,default=0.00)
	...
	precio         = models.DecimalField(max_digits=10, decimal_places=4,default=0.00)

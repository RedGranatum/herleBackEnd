...
class Compra(models.Model):
	...
	proveedor 	   = models.ForeignKey(Proveedor,default="",related_name='compra_id_proveedor', on_delete=models.PROTECT)		
	...
	precio_dolar   = models.DecimalField(max_digits=10, decimal_places=4,default=0.00)

...
class ClientesPago(models.Model):
	...
	cargo    				= models.DecimalField(max_digits=13, decimal_places=4,default=0.0,validators=[MinValueValidator(Decimal('0.00'))])
	abono    				= models.DecimalField(max_digits=13, decimal_places=4,default=0.0,validators=[MinValueValidator(Decimal('0.00'))])
